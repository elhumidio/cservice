...
{
    public class CreditsAvailableByUser
    {
        public class Query : IRequest<Result<CreditsAvailableByTypeCompanyAndUser>>
        {
        ...
        public class Handler : IRequestHandler<Query, Result<CreditsAvailableByTypeCompanyAndUser>>
        {
            ...
            IEnterpriseUserJobVacRepository enterpriseUserJobVacRepositor,
            IMediator mediatory)
            {
                _contractRepository = contractRepository;
                _jobOfferRepo = jobOfferRepository;
                _enterpriseUserJobVacRepository = enterpriseUserJobVacRepositor;
                _mediatr = mediatory;
            }
            ...
            public async Task<Result<CreditsAvailableByTypeCompanyAndUser>> Handle(Query request, CancellationToken cancellationToken)
            {
                CreditsAvailableByTypeCompanyAndUser creditsAvailableByTypeCompanyAndUser = new CreditsAvailableByTypeCompanyAndUser();
                var contracts = request.ContractsDist?.Distinct();
                var contractIdsList = request.ContractsDist?.Select(c => c.ContractId).ToList();
                ...
                foreach (var types in groupedByTypeCredits)
                {
                    if (types.Key == (int)VacancyTypesCredits.Basic)
                    {
                        ...
                        ProductUnitsForPublishOffer productUnitsForPublishOffer = new()
                        {
                            ...
                            ContractIdFinishingSoonest = (request.MultiplesUsers) ? 0 : await GetSoonestFinishingContractWithAvailableUnitsByType(contracts.ToList(), VacancyTypesCredits.Basic, request.IDEnterpriseUser),
                    ...
                    if (types.Key == (int)VacancyTypesCredits.Superior)
                    {
                        ...
                        ProductUnitsForPublishOffer productUnitsForPublishOffer = new()
                        {
                            ...
                            ContractIdFinishingSoonest = (request.MultiplesUsers) ? 0 : await GetSoonestFinishingContractWithAvailableUnitsByType(contracts.ToList(), VacancyTypesCredits.Superior, request.IDEnterpriseUser),
                            InternationalDifusion = false,
                            NationalDifusion = false,
                            IsBlindable = true,
                            IsFeatured = false,
                    ...
                    if (types.Key == (int)VacancyTypesCredits.Premium)
                    {
                        ...
                        ProductUnitsForPublishOffer productUnitsForPublishOffer = new()
                        {
                            ...
                            ContractIdFinishingSoonest = (request.MultiplesUsers) ? 0 : await GetSoonestFinishingContractWithAvailableUnitsByType(contracts.ToList(), VacancyTypesCredits.Premium, request.IDEnterpriseUser),
                            InternationalDifusion = false,
                    ...
                    if (types.Key == (int)VacancyTypesCredits.PremiumInternational)
                    {
                        ...
                        ProductUnitsForPublishOffer productUnitsForPublishOffer = new()
                        {
                            ...
                            ContractIdFinishingSoonest = (request.MultiplesUsers) ? 0 : await GetSoonestFinishingContractWithAvailableUnitsByType(contracts.ToList(), VacancyTypesCredits.PremiumInternational, request.IDEnterpriseUser),
                    ...
                    if (types.Key == (int)VacancyTypesCredits.Internship)
                    {
                        ...
                        ProductUnitsForPublishOffer productUnitsForPublishOffer = new()
                        {
                            ...
                            ContractIdFinishingSoonest = (request.MultiplesUsers) ? 0 : await GetSoonestFinishingContractWithAvailableUnitsByType(contracts.ToList(), VacancyTypesCredits.Internship, request.IDEnterpriseUser),
                            InternationalDifusion = false,
                            NationalDifusion = false,
                            IsBlindable = false,
                            IsFeatured = false,
